...
<div id="wrapper">
	<div id="page" class="container">
		...
		PreparedStatement st=con.prepareStatement("select *from response where customer=?");
		st.setString(1,name);
		...
		while(rs.next())
		{
				...
				<center>
				 ...
				 <tr>
				 <th><font color="Green">Your Request Proccessed by </font></th>
				 <th><font color="Green">Product</font></th>
				 <th><font color="Green">Cost</font></th>
				 <th><font color="Green">You Receives your Product On</font></th>
				 </tr>
				 <tr>
				<td><font color="red"><%=rs.getString(1)%></font></td>

					 <td><font color="red"><%=rs.getString(3)%></font></td>
					 
					 <td><font color="red"><%=rs.getString(4)%></font></td>
					 
					 <td><font color="red"><%=rs.getString(5)%></font></td>				 
				 </tr>
				 <%}%>
				 </table>
				 </center>
