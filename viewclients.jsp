...
<div id="wrapper">
	...
	<div id="featured-wrapper">
		<div id="featured" class="container">
			...
			<tr>
			<th><font color="red"><center>Name</center></font></th>
			<th><font color="red"><center>Utype</center></font></th>
			<th><font color="red"><center>Email</center></font></th>
			<th><font color="red"><center>Phone</center></font></th>
			<th><font color="red"><center>Address</center></font></th>
			</tr>
	<%
		String name=request.getParameter("name");
	    Class.forName("com.mysql.jdbc.Driver");
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/agriculture","root","root");
		PreparedStatement ps=con.prepareStatement("select *from reg where utype='customer'");
