...
<div id="wrapper">
	<div id="page" class="container">
		...
		if(rs.next())
		{
				...
				<center>
				<form action="request1.jsp?name=<%=request.getParameter("name")%>" method="post">
				 ...
				 <tr>
				 <td>Address</td>
				 <td><input type="text" name="address" value="<%=rs.getString("addr")%>"></td>
				 </tr>
				 <tr>
				 <td>Email</td>
				 ...
				 <tr>
				 <td colspan="2"><center><input type="submit" value="Send Request"></center></td>
				 </tr>
				 </table>
				 </form>
				 </center>
	...
	<div id="featured-wrapper">
		<div id="featured" class="container">
			<div class="column1"> <img src="images/Acephate.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Acephate&cost=950">Acephate</a></h2>
					<br>
					<h2>RS 950/-</h2>
				</div>
			...
			<div class="column2"> <img src="images/Carbendazim.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Carbendazin&cost=1030">Carbendazim</a></h2>
					<br>
					<h2>RS 1030/-</h2>
				</div>
			...
			<div class="column3"> <img src="images/Acetamiprid.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Acetamiprid&cost=1155">Acetamiprid</A></h2>
					<br>
					<h2>RS 1155/-</h2>
				</div>
			...
			<div class="column4"> <img src="images/Cartap.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Cartap&cost=1030">CartapHydrochloride</A></h2>
					<br>
					<h2>RS 1030/-</h2>
				</div>
		...
		<div id="featured" class="container">
			<div class="column1"> <img src="images/Chlorpyrifos.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Chlorpyrifos&cost=1550">Chlorpyrifos</A></h2>
					<br>
					<h2>RS 1550/-</h2>
				</div>
			...
			<div class="column2"> <img src="images/Cypermethrin.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Cypermethrin&cost=1335">Cypermethrin(</a></h2>
					<br>
					<h2>RS 1335/-</h2>
				</div>
			...
			<div class="column3"> <img src="images/Dimethoate.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Dimethoate&cost=1205">Dimethoate</a></h2>
					<br>
					<h2>RS 1205/-</h2>
				</div>
			...
			<div class="column4"> <img src="images/Ethion.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Ethion&cost=1350">Ethion</a></h2>
					<br>
					<h2>RS 1350/-</h2>
				</div>
		...
		<div id="featured" class="container">
			<div class="column1"> <img src="images/Fipronil.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Fipronil&cost=2050">Fipronil</a></h2>
					<br>
					<h2>RS 2050/-</h2>
				</div>
			...
			<div class="column2"> <img src="images/Glyphosate.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Glyphosate&cost=1865">Glyphosate</a></h2>
					<br>
					<h2>RS 1865/-</h2>
				</div>
			...
			<div class="column3"> <img src="images/Imidacloprid.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Imidacloprid&cost=3000">Imidacloprid</a></h2>
					<br>
					<h2>RS 3000/-</h2>
				</div>
			...
			<div class="column4"> <img src="images/Indoxacarb.jpg">
				<div class="title">
					<h2><a href="request.jsp?name=<%=request.getParameter("name")%>&product=Indoxacarb&cost=1475">Indoxacarb</a></h2>
					<br>
					<h2>RS 1475/-</h2>
				</div>
