...
<div id="wrapper">
	...
	<div id="featured-wrapper">
		<div id="featured" class="container">
			...
			<tr>
			<td><font color="red"><center>Name</center></font></td>
			<td><font color="red"><center>Product</center></font></td>
			<td><font color="red"><center>Cost</center></font></td>
			<td><font color="red"><center>Address</center></font></td>
			<td><font color="red"><center>email</center></font></td>
			<td><font color="red"><center>Phone</center></font></td>
			<td><font color="red"><center>status</center></font></td>
			</tr>
			<%while(rs.next())
			{		
			%>
			...
			<td><font color="red"><center><a href="deletereq.jsp?uname=<%=rs.getString(1)%>&product=<%=rs.getString(2)%>&cost=<%=rs.getString(3)%>&name=<%=request.getParameter("name")%>">Pending Clickhere to response</a></center></font></td>
			</tr>
			<%}%>
			</table>
			</center>
